...
export type TextareaPreviewState = "default" | "focus" | "error" | "success";
export type TextareaRadiusToken = "xs" | "sm" | "md" | "lg" | "xl";

type TextareaProps = TextareaHTMLAttributes<HTMLTextAreaElement> & {
  size?: TextareaSize;
  previewState?: TextareaPreviewState;
  radiusToken?: TextareaRadiusToken;
};

const BASE_STYLES =
  "w-full border bg-[var(--uiux-input-bg,var(--uiux-neutral100,#F8FAFC))] text-[var(--uiux-input-text,var(--uiux-neutral900,#0F172A))] placeholder:text-[var(--uiux-input-placeholder,var(--uiux-neutral600,#475569))] transition focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-[var(--uiux-input-disabled-opacity,0.6)] resize-y";
