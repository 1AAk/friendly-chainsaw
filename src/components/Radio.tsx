...
export type RadioPreviewState = "default" | "focus" | "error" | "success";
...
const BASE_STYLES =
  "relative inline-grid appearance-none place-content-center rounded-full border bg-[var(--uiux-input-bg,var(--uiux-neutral100,#F8FAFC))] text-[var(--uiux-input-text,var(--uiux-neutral900,#0F172A))] transition focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-[var(--uiux-input-disabled-opacity,0.6)]";
...
const CHECK_STYLES =
  "checked:border-[var(--uiux-primary,#F59E0B)] checked:bg-[var(--uiux-primary,#F59E0B)] after:pointer-events-none after:absolute after:h-2 after:w-2 after:rounded-full after:bg-[var(--uiux-neutral100,#F8FAFC)] after:opacity-0 checked:after:opacity-100";
const FOCUS_RING =
